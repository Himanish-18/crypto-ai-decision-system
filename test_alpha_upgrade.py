...
def test_alpha_upgrade():
    ...
    decision = decision_engine.make_decision(signal_output, 42000, win_rate=0.6, microstructure=micro_bullish)
    ...
    decision = decision_engine.make_decision(signal_output, 42000, win_rate=0.6, microstructure=micro_bearish)
