...
def run_verification():
    ...
    mock_router.fetch_unified_candles = AsyncMock(
        return_value=main_module.pd.DataFrame(
            {
    ...
    # Mock OB Manager
    mock_ob = MagicMock()
    mock_ob.get_latest_metrics = MagicMock(
        return_value={"spread": 1.0, "imbalance": 0.5}
    )
