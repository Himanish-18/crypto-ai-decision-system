...
class MicrostructureFeatures:
    ...
    def calculate_order_imbalance(self, order_book: Dict[str, Any], depth: int = 10) -> float:
        """
    ...
    def calculate_features(self, order_book: Dict[str, Any], trades: pd.DataFrame) -> Dict[str, float]:
        """
