...
# Import Agents
from src.agents.polymorph.momentum_reversal import (MeanReversalGhost,
                                                    MomentumHunter)
from src.agents.polymorph.vol_carry import CarryArchitect, VolatilityOracle
...
class MetaBrain:
    ...
    def think(self, market_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info(
            f"🧠 Meta-Brain Selects: {best['name']} | Sig: {best['signal']} | Conf: {best['conf']:.2f}"
        )
