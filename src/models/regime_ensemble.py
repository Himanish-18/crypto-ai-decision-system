...
class RegimeEnsemble:
    ...
    def __init__(self, n_components: int = 2):
        ...
        if GaussianHMM:
            self.hmm = GaussianHMM(n_components=n_components, covariance_type="full", n_iter=100)
        else:
            self.hmm = None
    ...
    def predict_risk(self, feature_vector: pd.DataFrame) -> Tuple[float, Dict[str, Any]]:
        """
