...
from src.models.train_model import split_data, prepare_features, train_xgboost, evaluate_model, save_artifacts
...
class RetrainingPipeline:
    ...
    def train_and_evaluate(self, df: pd.DataFrame):
        ...
        logger.info(f"Candidate Metrics: F1={metrics['f1_score']:.4f}, AUC={metrics['roc_auc']:.4f}")
    ...
    def run(self):
        try:
            ...
            if metrics["f1_score"] > 0.55:
                ...
                logger.info(f"Candidate F1 ({metrics['f1_score']:.4f}) below threshold. No promotion.")
