...
class StressGrid:
    ...
    def run_stress_test(self, portfolio_weights: Dict[str, float], current_value: float) -> pd.DataFrame:
        """
        ...
        if not crashes.empty:
            logger.warning(f"⚠️ PORTFOLIO FAILED STRESS TEST: {len(crashes)} scenarios lethal.")
