...
class NoiseFilter:
    ...
    """
    def __init__(self, window: int = 30, fft_threshold: float = 0.20, var_threshold: float = 0.0005):
        self.window = window
    ...
    def is_chop(self, closes: pd.Series) -> bool:
        ...
        is_noisy_spectrum = lf_ratio < self.fft_threshold # Energy is spread (White Noise)
