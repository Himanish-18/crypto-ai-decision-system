...
class MarketImpactModel:
    ...
    def estimate_impact_bps(self, size_usd: float, daily_vol_usd: float, volatility: float) -> float:
        """
    ...
    def recommend_max_size(self, max_impact_bps: float, daily_vol: float, volatility: float) -> float:
        """
