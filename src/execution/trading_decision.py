...
class TradingDecision:
    ...
    def make_decision(self, signal_output: Dict[str, Any], current_price: float, win_rate: float = 0.39, microstructure: Dict[str, float] = None) -> Dict[str, Any]:
        """
        ...
        if signal == 1:
            ...
            if confirmed:
                ...
                if size > 0:
                    ...
                    decision["reason"] = f"Signal Buy (Prob {prob:.2f}) + Orderflow Confirmed"
                else:
