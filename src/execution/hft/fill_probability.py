...
class FillProbabilityModel:
    ...
    def __init__(self):
        ...
        self.coef_obi = 1.0    # Positive Imbalance (Buy pressure) increases Prob for SELL orders? 
    ...
    def predict(self, side: str, distance_pct: float, obi: float) -> float:
        ...
        logit = self.intercept + (self.coef_dist * distance_pct * 1000) + (self.coef_obi * obi_factor)
