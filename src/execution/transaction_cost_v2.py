class TransactionCostModelV2:
    ...
    def estimate_cost(self, side: str, size: float, volatility: float, spread: float, mode: str = "TAKER"):
        """
    ...
    def is_profitable(self, expected_return: float, cost: float, min_margin: float = 0.0005) -> bool:
        """
