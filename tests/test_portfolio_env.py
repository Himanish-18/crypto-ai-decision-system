...
class TestPortfolioEnv(unittest.TestCase):
    def setUp(self):
        ...
        self.env = PortfolioEnv(self.assets, initial_balance=10000, transaction_cost_bps=5.0)
        self.agent = PPOPortfolioAgent(state_dim=self.env.state_dim, action_dim=self.env.action_dim)
